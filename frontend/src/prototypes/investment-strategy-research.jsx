const writingPhilosophy = {
  ...
  principles: [
    ...
    },
    {
      ...
      rule: "Each paragraph carries exactly one idea. If a second idea is needed, start a new paragraph. Investment research is especially prone to packing a thesis, supporting data, counterargument, and conclusion into a single dense block. That approach loses every reader. Separate the claim from the evidence from the implication.",
      examples: {
    ...
    },
    {
      ...
      rule: "When introducing any investment term, financial concept, or industry-specific language, ALWAYS lead with a real-world analogy. Define every acronym on first use. A reader who encounters DCF, WACC, or ROIC without explanation has already mentally checked out. Give them the idea first, then the label.",
      examples: {
    ...
    },
    {
      ...
      rule: "Every investment thesis has a bull case and a bear case. Both must be written with equal intellectual seriousness. A bear case that is two sentences long after a five-page bull case is not a bear case — it's decoration. Readers must be able to understand what would have to be true for this investment to fail.",
      examples: {
    ...
    },
    {
      ...
      rule: "The research document must tell a STORY: why this company exists, what changed to create the opportunity, what the market is missing, and what has to happen for the thesis to pay off. Sections must flow into each other — not feel like independent modules from a financial modeling course.",
      examples: {
    ...
    },
    {
      ...
      rule: "Connect financial metrics to real-world consequences wherever possible. 'Operating leverage expanded 400bps' is abstract. 'For every extra $1 of revenue the company earns, 60 cents drops straight to profit because the factory is already paid for' is concrete. Readers remember stories about people and outcomes — not basis points.",
      examples: {
    ...
    },
    {
      ...
      rule: "No number stands alone. Every financial metric must be compared to at least one of: (a) the company's own historical average, (b) direct competitors, or (c) a broader market benchmark. A 30% return on equity is exceptional in utilities and unremarkable in software. Without context, numbers are noise.",
      examples: {
    ...
    },
    {
      ...
      rule: "Every investment claim must be accompanied by an explicit time horizon. 'This is a great business' and 'this is a great stock to own for the next 12 months' are completely different statements. Mixing them creates confusion. Always specify: over what period does the thesis play out, and why?",
      examples: {
    ...
    },
    {
      ...
      rule: "Every section should pass this test: 'Could I explain this to a smart friend over dinner — without a whiteboard, without jargon, without losing their attention?' If you couldn't, rewrite it. The goal is not to impress with complexity. The goal is to transfer understanding.",
      examples: {
