...
PHASE_SPECS: dict[str, PhaseSpec] = {
    "M1": PhaseSpec(
        phase_id="M1",
        name="Macro Scan",
        inputs=(BASE_DIR / "M1 macro scan" / "script-research-functions.py",),
        outputs=(BASE_DIR / "M1 macro scan" / "output-research-macro-scan.json",),
    ...
    "M2": PhaseSpec(
        ...
        name="Sector Ranking",
        inputs=(
            BASE_DIR / "M2 Sector ranking" / "prompt-sector-ranking.md",
            BASE_DIR / "writing-phylosophy.jsx",
            BASE_DIR / "M1 macro scan" / "output-research-macro-scan.json",
        ),
        outputs=(BASE_DIR / "M2 Sector ranking" / "output-sector-ranking-report.md",),
    ...
    "M3": PhaseSpec(
        ...
        inputs=(
            BASE_DIR / "M3A Universe generation" / "prompt-universe-generation.md",
            BASE_DIR / "M2 Sector ranking" / "output-sector-ranking-report.md",
            BASE_DIR / "M1 macro scan" / "output-research-macro-scan.json",
        ),
        outputs=(BASE_DIR / "M3A Universe generation" / "output-universe-generation.json",),
