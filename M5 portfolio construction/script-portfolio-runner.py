...
DEFAULT_M3B_PATH = BASE_DIR / "M3B stock screening" / "output-stock-screener.txt"
DEFAULT_MACRO_PATH = BASE_DIR / "M1 macro scan" / "output-research-macro-scan.json"
DEFAULT_API_DATA_PATH = BASE_DIR / "M3A Universe generation" / "output-universe-generation-api.json"
DEFAULT_OUTPUT_PATH = Path(__file__).parent / "output-portfolio-construction.txt"
